var oneone = Mario.oneone = function() {
  ...
  level = new Mario.Level({
    ...
    castletop: new Mario.Sprite('sprites/tiles.png', [176,0],[16,16],0),
    castletopOver: new Mario.Sprite('sprites/tiles.png', [176,16],[16,16],0),
    castlewall: new Mario.Sprite('sprites/castle.png', [1,80],[16,16],0),
    castledoor:new Mario.Sprite('sprites/castle.png', [32,80],[16,16],0),
    castledoortop:new Mario.Sprite('sprites/tiles.png', [192,16],[16,16],0),
    castledoorleft:new Mario.Sprite('sprites/tiles.png', [192,0],[16,16],0),
    castledoorright:new Mario.Sprite('sprites/tiles.png', [224,0],[16,16],0),

    castle:new Mario.Sprite('sprites/castle.png', [0,0],[32,96],0),
    castle1:new Mario.Sprite('sprites/castle.png', [32,0],[16,80],0),
    castle2:new Mario.Sprite('sprites/castle.png', [48,0],[32,96],0),
    ...
    hadokenFlowerSprite: new Mario.Sprite('sprites/items.png', [160,32], [16,16], 20, [0,1,2,3]),
  ...
  ground = [[0,69],[71,86],[89,153],[155,220]];
...
*/
  ...
  castlewall = [1]
  castlewall.forEach(function(castlewall) {
    level.putcastlewall(castlewall, 13);
  });
  /*
  castle = [0]
  castle.forEach(function(castle) {
    level.putcastle(castle, 12);
  });*/
  ...
  level.putQBlock(22, 5, new Mario.Mushroom([352, 80]));
