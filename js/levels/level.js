(function() {
  var Level = Mario.Level = function(options) {
    ...
    this.castletop = options.castletop;
    this.castletopOver = options.castletopOver;
    this.castlewall = options.castlewall;
    this.castledoor = options.castledoor;
    this.castledoorleft = options.castledoorleft;
    this.castledoortop = options.castledoortop;
    this.castledoorright = options.castledoorright;

    this.door = options.door;
    this.castle = options.castle;
    this.castle1 = options.castle1;
    this.castle2 = options.castle2;
...
//FIX DOOR
  ...
  Level.prototype.putcastlewall = function(x, y) {

    for (var i = y-2; i < y; i++) {
      this.scenery[i][x] = new Mario.Prop([16*x, 16*i], this.castlewall);
      this.scenery[i][x+1] = new Mario.Prop([16*(x+1), 16*(i)], this.castlewall);

      this.scenery[i][x+2] = new Mario.Prop([16*(x+2), 16*(i)], this.castledoor);

      this.scenery[i][x+3] = new Mario.Prop([16*(x+3), 16*(i)], this.castlewall);
      this.scenery[i][x+4] = new Mario.Prop([16*(x+4), 16*(i)], this.castlewall);
    }
  };
